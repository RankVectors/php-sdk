...
class UserApi
{
     ...
     * @return \OpenAPI\Client\Model\GetUserInfo200Response|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetUserInfo200Response|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\GetUserInfo200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\OpenAPI\Client\Model\GetUserInfo200Response';
        $request = $this->getUserInfoRequest($contentType);
