...
/**
 * PagePricingTiersInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PagePricingTiersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PagePricing_tiers_inner';
    ...
    */
    ...
    public function setAnnualPrice($annual_price)
    {
        if (is_null($annual_price)) {
            throw new \InvalidArgumentException('non-nullable annual_price cannot be null');
        }
