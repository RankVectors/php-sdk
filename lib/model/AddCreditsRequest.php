...
/**
 * AddCreditsRequest Class Doc Comment
 *
 * @category Class
 * @package  com.rankvectors
 * @author   OpenAPI Generator team
 ...
 */
class AddCreditsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addCredits_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('source', $data ?? [], 'manual_addition');
    }
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling AddCreditsRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets source
     *
     * @param string|null $source Source of credits
     *
     * @return self
     */
