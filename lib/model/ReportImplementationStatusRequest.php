...
/**
 * ReportImplementationStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReportImplementationStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'reportImplementationStatus_request';
    ...
    */
     ...
     * Sets suggestion_id
     *
     * @param string $suggestion_id ID of the suggestion
     *
     * @return self
     */
     ...
     * Sets api_key
     *
     * @param string $api_key Your RankVectors API key
     *
     * @return self
     */
